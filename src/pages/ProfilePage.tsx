    ...
    <div className="mx-auto max-w-5xl p-4 md:p-6 lg:p-7">
      ...
      <div className="mt-5 space-y-4">
        {tab === 'personal' && (
          <>
            <section className="rounded-2xl border border-gray-200 bg-white p-5">
              ...
              <h2 className="mt-2 text-3xl font-semibold text-gray-900">Your trader nickname</h2>
              <p className="mt-1 text-sm text-gray-500">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <div className="relative min-w-[320px] flex-1">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border border-gray-200 bg-gray-50 pl-9 pr-3 text-base font-medium outline-none focus:border-[#003d7a]"
                  />
                </div>
                <button
                  type="button"
        ...
        {tab === 'preferences' && (
          <>
            <section className="rounded-2xl border border-gray-200 bg-white p-5">
              <h2 className="text-3xl font-semibold text-gray-900">Appearance</h2>
              <p className="mt-1 text-sm text-gray-500">Choose how the client area looks for you.</p>
              <div className="mt-3 inline-flex rounded-xl border border-gray-200 bg-gray-50 p-1">
                <button
                  ...
                  className={cn(
                    ...
                    !isDark ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500',
                  )}
                >
            ...
            <section className="rounded-2xl border border-gray-200 bg-white p-5">
              <h3 className="text-2xl font-semibold text-gray-900">Communication preferences</h3>
              <p className="mt-1 text-sm text-gray-500">
              ...
              <div className="mt-3 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2">
                ...
                <div className="mt-1 flex items-center justify-between text-sm">
                  <span className="text-gray-500">We&apos;ll use this number for WhatsApp / SMS / calls.</span>
                  <span className="rounded-full bg-white px-3 py-1 font-medium text-gray-700">
                    {user?.phone ?? '+91 0000000000'} <span className="text-xs text-gray-500">(from profile)</span>
                  </span>
                </div>
              </div>
              ...
              <label className="mt-4 flex cursor-pointer items-start gap-2">
                ...
                />
                <span>
                  <span className="block text-sm font-medium text-gray-900">Get onboarding help & account updates</span>
                  <span className="text-xs text-gray-500">Used only for onboarding/support. You can opt out anytime.</span>
                </span>
              </label>

              <div className="mt-4 border-t border-gray-200 pt-4">
                <p className="text-sm text-gray-600">Choose your preferred channel:</p>
                  ...
                  {([
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        channel === id ? 'bg-[#003d7a] text-white' : 'border border-gray-200 bg-white text-gray-700',
                      )}
                    >
                      {label}
                    </button>
              ...
              <div className="mt-4 flex items-center justify-between border-t border-gray-200 pt-4">
                <p className="text-sm text-gray-600">Something wrong or want a new feature? Contact support</p>
                <button
                  type="button"
              ...
              <div className="mt-4 rounded-xl border border-gray-200 bg-[#fff6f6] p-4">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="text-base font-semibold text-gray-900">Daily Kill Switch</p>
                    <p className="mt-1 text-sm text-gray-500">
                ...
                <div className="mt-3 flex items-center justify-between rounded-xl border border-gray-200 bg-white p-3">
                  <div>
                    <p className="text-sm font-medium text-gray-900">Trading protection status</p>
                    <p className="text-xs text-gray-500">You can activate the kill switch once for the current trading day.</p>
                  </div>
                  <button
                    type="button"
        ...
        {tab === 'verified' && (
          <section className="rounded-2xl border border-gray-200 bg-white p-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-2xl font-semibold text-gray-900">Verified Trader Status</h2>
            </div>
...
function Field({
  ...
  return (
    <div>
      ...
      <div className="mt-1 flex h-11 items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-3">
